...
class GraphHandler:
    ...
    def reset(
        ...
        try:
            ...
            if self._current_location == None or self._current_location == "":
                self._current_location = current_location
    ...
    def path_exists_from_current_loc(self, target: str) -> bool:
        assert self._current_location != None, "current location is unknown"
    ...
    def get_closest_reachable_node(
        ...
        if current_node == None:
            assert self._current_location != None, "current_location must be set"
