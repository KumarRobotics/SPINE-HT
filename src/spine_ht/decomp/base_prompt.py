...
from spine_ht.decomp.prompts.gpt4_prompt import GPT4_POSTPEND, GPT4_PROMPT_TEMPLATE
from spine_ht.decomp.prompts.gpt5_prompt import GPT5_POSTPEND, GPT5_PROMPT_TEMPLATE

file_root = importlib.resources.files("spine_ht")
