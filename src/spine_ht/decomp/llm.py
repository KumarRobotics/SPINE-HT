...
from spine_ht.allocation.assignment import TaskDescription  # noqa: E402
from spine_ht.decomp.base_prompt import build_prompt  # noqa: E402
from spine_ht.decomp.util import _parse_function_call  # noqa: E402
from spine_ht.planner_logging import break_long_str  # noqa: E402
...
class MissionDecomp:
    ...
    def _build_query(self) -> List[Dict[str, str]]:
        assert self._mission_specification != "", "must set mission specification"
    ...
    def _parse_task_requirements(
        ...
        if (
            function_name.startswith("ugv")
            or function_name.startswith("explore")
            and "ugv_type" in task_kwargs
        ):
...
if __name__ == "__main__":
    ...
    deps = [
        [
            "uav_map(region_node='ground_9')",
            "ugv_map_region(region_node='road_1_from_uav', ugv_type='spot')",
        ],
        [
            "uav_map(region_node='ground_9')",
            "ugv_map_region(region_node='road_2_from_uav', ugv_type='spot')",
        ],
        [
