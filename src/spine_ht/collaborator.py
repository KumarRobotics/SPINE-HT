...
from spine_ht.allocation.assignment import (
    RobotDescription,
    RobotTaskAssigment,
    TaskDescription,
)
from spine_ht.allocation.translator import (
    translate_task_for_execution,
    translate_task_for_validation,
)
from spine_ht.decomp.llm import MissionDecomp
from spine_ht.planner_logging import break_long_str
from spine_ht.spine.mapping.graph_util import GraphHandler
from spine_ht.spine.validator import Validator
...
class Collaborator:
    def __init__(
        ...
        self._mission_decomp = MissionDecomp(
            team_specification=team_spec_language,
            llm_type=llm_type,
            logger=self._logger,
        )
