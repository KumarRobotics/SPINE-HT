...
from spine_ht.spine.models import OpenAILLM
from spine_ht.spine.prompts.prompts import INVALID_JSON
...
class SPINE:
    ...
    def resume_request(self) -> Tuple[Dict[str, Any], bool, List[str]]:
        assert len(self.most_recent_query), "must have history to regenerate plan"
